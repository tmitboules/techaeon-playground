...
export enum Shapes {
  ...
  hexagon = "M 55 25 C 120 -8 120 -8 180 25 C 240 55 240 55 240 120 C 240 185 240 185 185 215 C 120 246 120 246 55 215 C 0 185 0 185 0 120 C 0 55 0 55 55 25 Z M 165 50 C 120 28 120 28 75 50 C 35 70 35 70 35 120 C 35 170 35 170 70 190 C 120 215 120 215 170 190 C 205 170 205 170 205 120 C 205 70 205 70 165 50 Z M 55 50 C 120 15 120 15 185 50 C 225 5 225 235 190 190 C 120 230 120 230 54 190 C 15 235 15 5 55 50 Z",
}
