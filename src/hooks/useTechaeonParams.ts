...
export const techaeonShapes = {
  ...
  hexagon:
    "M 1 118 L 60 1 C 60.43 0.18 61 0 62 0 L 179 0 C 180 0 180.43 0.18 181 1 L 239 118 Q 240 120 239 122 L 189 239 C 188.43 239.82 188 240 187 240 L 62 240 C 61 240 60.43 239.82 60 239 L 1 122 Q 0 120 1 118 Z",
  square:
    "M 12 0 L 238 10 Q 240.1 10.1 240 12 L 230 238 Q 229.9 240.1 228 240 L 2 230 Q -0.1 229.9 0 228 L 10 2 Q 10.1 -0.1 12 0 Z",
  // square:
